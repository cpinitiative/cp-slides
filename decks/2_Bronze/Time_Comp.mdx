...
https://usaco-guide.netlify.app/bronze/time-comp
...
A significant portion of Bronze problems will have $n\le 100$. This doesn't give much of a hint regarding the intended time complexity. The intended solution could still be $O(n)$!
